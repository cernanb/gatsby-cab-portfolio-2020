      ...
      <Container noGutter mobileGutter width="1200px">
        <Box {...row}>
          <Box {...contentArea}>
            ...
            <Heading content="Cernan Bernardo" {...nameStyle} />
            <Heading content="Full Stack Web Developer" {...designationStyle} />
            <Box {...roleWrapper}>
              <Icon
                ...
                size={22}
              />
              <Heading content="Freelance Developer" {...roleStyle} />
            </Box>
            <Text
              content="I create full-featured, interactive websites."
              {...aboutStyle}
            />
